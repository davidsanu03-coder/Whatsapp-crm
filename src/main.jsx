...
const emptyLead = {
  name: "", email: "", phone: "", whatsapp_name: "", business_name: "",
  interest: "", deal_value: "", status: "new", next_follow_up_at: "", notes: "",
};
  ...
  return (
    <div className="auth">
      <div className="authCard">
        ...
        <p>Manage leads, follow-ups, messages and AI-assisted sales from one place.</p>
        {sent ? (
    ...
    <div className="app">
      <aside>
        ...
        <nav>
          ...
          <button className={activeView === "leads" ? "navActive" : ""} onClick={() => setActiveView("leads")}>Leads</button>
          <button className={activeView === "messages" ? "navActive" : ""} onClick={() => setActiveView("messages")}>Messages</button>
        </nav>
